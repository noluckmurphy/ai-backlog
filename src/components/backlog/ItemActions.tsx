  ...
  return (
    <div className="flex items-center gap-2 mt-3">
      <button
        ...
        className="px-3 py-1 text-[10px] font-bold uppercase bg-gray-900 text-gray-50 border border-gray-900 hover:bg-gray-700"
      >
        Accept
      </button>
      <button
        onClick={() => onStatusChange('rejected')}
        className="px-3 py-1 text-[10px] font-bold uppercase border border-gray-400 hover:bg-gray-200"
      >
        Reject
      </button>
      <button

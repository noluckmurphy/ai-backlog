...
export default function CategoryBreakdownTable() {
  return (
    <div className="border border-gray-400">
      <h3 className="text-xs font-bold uppercase px-4 py-2 border-b border-gray-400">
        Category Breakdown
      </h3>
      <table className="w-full text-xs">
        <thead>
          <tr className="border-b border-gray-400 bg-gray-100">
            ...
            <th className="text-right px-4 py-2 font-bold">Mentions</th>
            <th className="text-right px-4 py-2 font-bold">Avg Sentiment</th>
            <th className="text-center px-4 py-2 font-bold">Trend</th>
            <th className="text-left px-4 py-2 font-bold">Top Keywords</th>
          </tr>
        </thead>
        <tbody>
